...
module.exports = {
    ...
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.imgur.com/9zRNU2w.jpg' : process.env.GAN_IMAGE,
    ...
    PHONE: process.env.NUMBER === undefined ? '+919495944713' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'Das_ser' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Das_ser' : process.env.ALL_CAPTION,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://i.imgur.com/9zRNU2w.jpg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'Das_ser' : process.env.LOGO_NAME,
    MENTION: process.env.TAG_REPLY === undefined ? '919495944713@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ ᴅᴀssᴇʀ ⋈ ‒‒‒⊣' : process.env.BOT_NAME,    
    ...
    YAK: process.env.YAK === undefined ? '919495944713,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
