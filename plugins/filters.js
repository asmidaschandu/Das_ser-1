...
const array = ['antha ppd','avida','Busy','hey','King','loving','omg','sorry','Avida','Antha ppd','busy','Hey','king','Loving','OMG','Sorry','Ayoo','ayoo','Broken','broken','I love u','Lub','lub','Reply','reply','Sad','sad','Salman','salman','Sketched','sketched','Zahra','zahra','thegamerZ','TGS gamer Z','vishvesh','Veena','Madhav','Chandana','Asmin','Adithyan','Adithya','Vishvesh','veena','madhav','chandana','asmin','adithyan','adithya','Zhara','Super','Set','Phaa','owner','Namaskaram','Mm','Lub','Love','Kk','inventer','Hyy','hlo','Hi','hai','Gym','Deal','Das','Aa','zhara','vandairunu','super','silence','set','Power','poda','phaa','penne','penallah','panam','Owner','odada','nirthada','namaskaram','money','mm','mad','lub','love','kk','Inventer','hyy','Hlo','hi','hehe','Hai','Haa','gym','Enthua ivide','ena adutho','eee','deal','das','cash','ayoo','aa','poda','power','BTS','Chunk','Vijay','Vijay Annan','xxx','vava','thalapathy','Tentacion','Manjappada','Kerala Blasters','Kbfc','Kanjav','fuck','fek','Amalser','chaya','escape','truth','hm','pottan','oh','nokk','nude','oo','kali','Remove','bot','lost','copy','Da','come','sex','help','sorry','podi','nee','done','kalam','Di','Dey','oho','Welcome','Nanba','ee','Hello','para','kindi','list','check','podey','odiko','save','Hii','oii','sad','sed','thenga','bad','run','remove','love','kick','enth','alive','amal','menu','ella','unmute','mute']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
